...
'
' If nCode >= 0 And Not (CDialog Is Nothing) Then
'  If wParam = 9 Then
'
...
'      If frmAddToProject.SetBackwardFocus Then
...
'     If lParam = 135200769 Or lParam = 1208942593 Or lParam = 983041 Or 1074724865 Then
'      If frmAddToProject.SetForwardFocus Then
'       TabKeyProc = 1&: Exit Function
'      End If
'     End If
'
...
'   If frmAddToProject.IsNew Then
'    If Not (frmAddToProject.lvwNew.SelectedItem Is Nothing) Then
'     If frmAddToProject.lvwNew.SelectedItem.text <> "" Then
'      frmAddToProject.cmdNewOpen.value = True
'      TabKeyProc = 1: Exit Function
'     End If
'    End If
'   End If
